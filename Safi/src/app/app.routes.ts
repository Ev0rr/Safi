...
export const routes: Routes = [
  ...
  { path: 'group-chats', loadComponent: () => import('./pages/group-chats/group-chats.page').then(m => m.GroupChatsPage) },
  { path: 'vista-chat', loadComponent: () => import('./pages/vista-chat/vista-chat.page').then(m => m.VistaChatPage) },
  {
    path: 'group-chats',
  ...
  {
    path: 'vista-chat',
    loadComponent: () => import('./pages/vista-chat/vista-chat.page').then( m => m.VistaChatPage)
  }
